...
from ..utils.arg_types import randIntInRange
...
class Entry(BaseNdbModel):  # ndb.model.Expando
    ...
    comments = ndb.StringProperty(indexed=False, default="")  # any notes or comments
    shareDetails = ndb.StringProperty(
    ...
    categoryCode = ndb.StringProperty(
        indexed=False, default="communicationPos"
    )  # top category
